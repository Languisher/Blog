---
title: 无 sudo 权限下用 conda 管理二进制软件
...
---
在很多情况下，我们希望在公司或学校的服务器上安装自己需要的软件包。然而，大多数服务器都基于 Debian 系 Linux 发行版，而系统默认通常只提供 `apt` 作为包管理工具。和其他系统级包管理器一样，`apt` 需要 **sudo 权限** 才能安装软件。
